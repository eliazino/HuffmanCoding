...
namespace Core.Shared {
    public class Cryptography {
        ...
        public class CharGenerator {
            ...
            public static string keyFromStrings(params string[] str) {
                string conCated = string.Concat(str);
                string merged = "";
                HashSet<char> uniqueChars = new HashSet<char>(conCated);
                foreach(char c in uniqueChars) {
                    merged += c;
                }
                return Hash.getHash(merged);
            }
